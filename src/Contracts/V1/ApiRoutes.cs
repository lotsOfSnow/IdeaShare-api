namespace IdeaShare.Contracts.V1
{
    public static class ApiRoutes
    {
        ...
        public static class Users
        {
            ...
            public const string Update = Base + "/users/{username}"; // POST
        ...
        public static class Articles
        {
            ...
            public const string Update = Base + "/articles/{articleId}"; // POST
            ...
            public static class Comments
            {
                ...
                public const string Update = Base + "/articles/{articleId}/comments/{commentId}"; // POST
